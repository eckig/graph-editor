...
# Replaced: "target/classes/com/dlsc/jpackagefx/App.class" --> "target/classes/de/tesis/dynaware/grapheditor/demo/GraphEditorDemo.class"
...
JAVA_VERSION=14
MAIN_JAR="graph-editor-demo-$PROJECT_VERSION.jar"
...
detected_modules=`$JAVA_HOME/bin/jdeps \
  ...
  --class-path "target/installer/input/libs/*" \
    target/classes/de/tesis/dynaware/grapheditor/demo/GraphEditorDemo.class`
...
--icon src/main/resources/de/tesis/dynaware/grapheditor/demo/logo/linux/duke.png \
