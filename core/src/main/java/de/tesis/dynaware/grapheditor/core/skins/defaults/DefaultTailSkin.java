...
public class DefaultTailSkin extends GTailSkin {
    ...
    private static final String STYLE_CLASS = "g-tail";
    private static final String STYLE_CLASS_ENDPOINT_INPUT = "g-tail-endpoint-input";
    private static final String STYLE_CLASS_ENDPOINT_OUTPUT = "g-tail-endpoint-output";
